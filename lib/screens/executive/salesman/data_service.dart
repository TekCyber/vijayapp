...
class DataService {
  ...
  // Get sub group 2 by brand
  Future<List<String>> getSubGroup2ByBrand(String brand) async {
    try {
      Map<String, dynamic> payload = {
        "sqlKey": "GET_ALL_SUBGROUP2_BY_BRAND",
        "brand": brand,
      };
      ...
      if (response.isSuccess && response.data != null) {
        List<String> names = List<Map<String, dynamic>>.from(response.data!)
      ...
      print('Error fetching sub group 2: $e');
      return [];
    }
  }
  ...
  Future<List<Map<String, dynamic>>> getDealerCountByBrand({
    required String period,
    String? brand,
    String? route,
  }) async {
    try {
      ...
      String sqlKey = "GET_DEALER_COUNT_BY_BRAND_${period}_MOM";
  ...
  // Get pending sales orders by dealer and executive
  Future<List<Map<String, dynamic>>> getPendingOrders({
    ...
    try {
      ...
      Map<String, dynamic> payload = {
        "sqlKey": "GET_DEALER_PENDING_SALES_ORDERS",
        "dealername": dealerName ?? "%",
        "executive": salesMan != "null" ? salesMan : executive,
      };
