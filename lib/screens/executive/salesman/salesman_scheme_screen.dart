...
class _SchemeScreenState extends State<SchemeScreen>
  ...
  List<Map<String, dynamic>> _slabThresholds = [];
  ...
  double _analyzeTransactionDataForTarget(String schemeName, int targetSlabValue, double currentAmount) {
    ...
    if (achievedAmountsAtTargetSlab.isNotEmpty) {
      ...
      return achievedAmountsAtTargetSlab.first;
    }
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                decoration: ThemeHelper.badgeDecoration(ThemeHelper.infoColor),
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Icon(Icons.info_outline, color: ThemeHelper.infoColor, size: 12),
                    SizedBox(width: 4),
                    Text(
                      'Schemes',
                      style: TextStyle(
          ...
          children: [
            Row(
              children: [
                Icon(
                  icon,
                  color: enabled ? Theme.of(context).primaryColor : ThemeHelper.subtleTextColor(context),
                  size: 14,
                ),
                SizedBox(width: 6),
                Expanded(
                  child: Text(
                    label,
                    style: TextStyle(
                      color: enabled ? subtleColor : ThemeHelper.subtleTextColor(context),
                      fontSize: 11,
                      fontWeight: FontWeight.w600,
                    ),
                  ),
            ...
            if (errorMessage.isNotEmpty)
              Text(
                errorMessage,
                style: TextStyle(color: ThemeHelper.errorColor, fontSize: 10),
              )
            else if (isLoading)
              Text(
                'Loading...',
                ...
                Text(
                  'Not available',
                  style: TextStyle(color: ThemeHelper.subtleTextColor(context), fontSize: 13),
                )
              else if (items.isEmpty)
                  Text(
                    'No options found',
                    style: TextStyle(color: ThemeHelper.warningColor, fontSize: 13),
                  )
                else
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(Icons.error_outline, color: ThemeHelper.errorColor, size: 48),
            ),
            SizedBox(height: 20),
            Text(
            ...
            Text(
              _errorMessageTransactions,
              style: TextStyle(color: ThemeHelper.errorColor.withOpacity(0.8), fontSize: 14),
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(Icons.receipt_long, color: ThemeHelper.infoColor, size: 48),
            ),
            SizedBox(height: 20),
            Text(
            ...
            children: [
              ...
              if (selectedScheme != null || selectedRoute != null) ...[
                GestureDetector(
                  ...
                  child: Container(
                    padding: EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                    decoration: ThemeHelper.badgeDecoration(ThemeHelper.warningColor),
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Icon(Icons.clear, color: ThemeHelper.warningColor, size: 12),
                        SizedBox(width: 4),
                        Text(
                          'Clear',
                          style: TextStyle(
  ...
  Widget _buildTransactionRow(Map<String, dynamic> transaction, int index) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(
          bottom: BorderSide(color: ThemeHelper.borderColor(context), width: 0.5),
        ),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            children: [
              ...
              Container(
                padding: EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                decoration: ThemeHelper.badgeDecoration(ThemeHelper.getStatusColor(schemeAchievement)),
                child: Text(
                  schemeAchievement,
                  style: TextStyle(
                    color: ThemeHelper.getStatusColor(schemeAchievement),
                    fontSize: 10,
                    fontWeight: FontWeight.w600,
                  ),
                ),
            ...
            children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: [
                            ThemeHelper.infoColor.withOpacity(0.2),
                            ThemeHelper.infoColor.withOpacity(0.1),
                          ],
                        ),
                        borderRadius: BorderRadius.circular(6),
                        border: Border.all(color: ThemeHelper.infoColor.withOpacity(0.3), width: 1),
                      ),
                      child: Text(
              ...
              if (amountNeeded > 0) ...[
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Next: ${nextSlabName}',
                        style: TextStyle(
                          color: ThemeHelper.warningColor.withOpacity(0.9),
                          fontSize: 9,
                          fontWeight: FontWeight.w500,
                        ),
                      ),
                      Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: [
                              ThemeHelper.warningColor.withOpacity(0.2),
                              ThemeHelper.warningColor.withOpacity(0.1),
                            ],
                          ),
                          borderRadius: BorderRadius.circular(6),
                          border: Border.all(color: ThemeHelper.warningColor.withOpacity(0.4), width: 1),
                        ),
                        child: Column(
                          children: [
                            Row(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                Icon(Icons.trending_up, color: ThemeHelper.warningColor, size: 8),
                                SizedBox(width: 2),
                                Text(
                            ...
                            if (nextSlabInfo['reward'] != null && nextSlabInfo['reward'].toString().isNotEmpty) ...[
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                  color: ThemeHelper.warningColor.withOpacity(0.8),
                                  fontSize: 7,
                                ),
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                ...
                Expanded(
                  child: Container(
                    padding: EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                    decoration: ThemeHelper.badgeDecoration(ThemeHelper.successColor),
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Icon(Icons.check_circle, color: ThemeHelper.successColor, size: 10),
                        SizedBox(width: 4),
                        Text(
                          'Achieved',
                          style: TextStyle(
                  ...
                  children: [
                    ...
                    if (finalGift != 'N/A' && finalGift.isNotEmpty) ...[
                      Container(
                        ...
                        decoration: ThemeHelper.smallBadgeDecoration(ThemeHelper.accentPurple),
                        child: Text(
                          'Gift: $finalGift',
                          style: TextStyle(
    ...
    return Container(
      ...
      child: Column(
        children: [
          Row(
            children: [
              Icon(Icons.calculate, color: Theme.of(context).primaryColor, size: 20),
              SizedBox(width: 8),
              Text(
                'Summary',
                style: TextStyle(
